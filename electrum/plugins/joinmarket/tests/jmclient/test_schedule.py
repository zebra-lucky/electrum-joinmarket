...
from electrum.plugins.joinmarket.jmclient import (
    get_schedule, get_tumble_schedule, tweak_tumble_schedule)
...
class ScheduleTestCase(JMTestCase, ParametrizedTestCase):
    ...
    def test_tumble_schedule(self, destaddrs, txcparams, mixdepthcount,
                             mixdepthbal):
    ...
    def test_tumble_tweak(self, destaddrs, txcparams, mixdepthcount,
        ...
        new_schedule = tweak_tumble_schedule(
            self.jmman, options, schedule, lastcompleted)
