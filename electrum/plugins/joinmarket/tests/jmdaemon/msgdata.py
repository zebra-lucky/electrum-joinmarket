...
t_utxos_by_mixdepth = {
    0: {
        '534b635ed8891f16c4ec5b8236ae86164783903e8e8bb47fa9ef2ca31f3c2d7a:0': {
            'address': 'mrcNu71ztWjAQA6ww9kHiW3zBWSQidHXTQ',
            'value': 200000000}},
    1: {
        '0780d6e5e381bff01a3519997bb4fcba002493103a198fde334fd264f9835d75:1': {
            'address': 'mvtY8DVgn3TtvjHbVsauYoSQjAhNqVyqmM',
            'value': 200000000},
        '7e574db96a4d43a99786b3ea653cda9e4388f377848f489332577e018380cff1:0': {
            'address': 'n3nELhmU2D7ebGYzJnGFWgVDK3cYErmTcQ',
            'value': 200000000},
        'dd9711a2ef340750db21efb761f5f7d665d94b312332dc354e252c77e9c48349:0': {
            'address': 'mxeLuX8PP7qLkcM8uarHmdZyvP1b5e1Ynf',
            'value': 200000000}},
    2: {},
    3: {},
    4: {}}
...
t_generated_podle = {
    ...
    'commit':
        'aa0545c9ed918e66f86df467c96a4978529b836aa4688df682a2db4e27d4ed9d',
...
t_maker_response = {
    "J559UPUSLLjHJpaB": [
        ...
        "MEQCIBeGrtxxVrj5tSUX6vEetmzE8nRBG/guSXq3SrqypIt5AiAnIZzDUXu8DtOD"
        "gF2p1Bo27L8VcG1GJSfatZbS23YZQQ==",
    ...
    "J55z23xdjxJjC7er": [
        ...
        "MEQCIBlMF7DRbhr14e74He9m+UYjR5y8jjvP7TvUh8valebmAiBoIGjl436fsYim"
        "9pKSTbCKiBmT82hQ98LvIOGSLprk0A==",
    ...
    "J5CFffuuewjG44UJ": [
        ...
        "MEUCIQDAM5Aa0aU5iKI0b9YnNtwH0m+6sz3zeTL8f398CPjuQAIgLeU9mCJX8Sup"
        "NNMkA+bsUJeRYe3kiLnzq3OlmXTxck0=",
...
fee breakdown for J559UPUSLLjHJpaB totalin=200000000 cjamount=110000000
txfee=1000 realcjfee=22000
rpc: gettxout
['498faa8b22534f3b443c6b0ce202f31e12f21668b4f0c7a005146808f250d4c3', 0, False]
fee breakdown for J55z23xdjxJjC7er totalin=200000000 cjamount=110000000
txfee=1000 realcjfee=22000
rpc: gettxout
['3f3ea820d706e08ad8dc1d2c392c98facb1b067ae4c671043ae9461057bd2a3c', 1, False]
fee breakdown for J5CFffuuewjG44UJ totalin=200000000 cjamount=110000000
txfee=1000 realcjfee=22000
...
fee breakdown for me totalin=200000000 my_txfee=23100 makers_txfee=3000
...
"""
nick=J5CFffuuewjG44UJ message=!sig
...
7pS3/atADSqPat0U=
nick=J559UPUSLLjHJpaB message=!sig
...
6DerByuEuk5IBSQ==
nick=J55z23xdjxJjC7er message=!sig
...
nick = J5CFffuuewjG44UJ sent all sigs, removing from nonrespondant list
rpc: gettxout
['03243f4a659e278a1333f8308f6aaf32db4692ee7df0340202750fd6c09150f6', 1, False]
rpc: gettxout
['498faa8b22534f3b443c6b0ce202f31e12f21668b4f0c7a005146808f250d4c3', 0, False]
found good sig at index=0
nick = J559UPUSLLjHJpaB sent all sigs, removing from nonrespondant list
rpc: gettxout
['498faa8b22534f3b443c6b0ce202f31e12f21668b4f0c7a005146808f250d4c3', 0, False]
found good sig at index=2
nick = J55z23xdjxJjC7er sent all sigs, removing from nonrespondant list
...
t_raw_signed_tx = (
    "0100000004f65091c0d60f75020234f07dee9246db32af6a8f30f833138a279e654a3f"
    "2403010000006b483045022100ad522388ce9eacf2760e4d6bd6a114a0e15b88879b43"
    "0fbb2e60df947494df2402201f49338726599eb0980873aef268d8d890de2792967ff2"
    "8f0c11eb35e54ff07a012103a2d1cbe977b1feaf8d0d5cc28c686859563d1520b28018"
    "be0c2661cf1ebe4857ffffffff3c2abd571046e93a0471c6e47a061bcbfa982c392c1d"
    "dcd88ae006d720a83e3f010000006a473044022012bbfa6ef7b0416e00001d90b022d6"
    "663f5fd57d9a07bb70b887510f7c44902d022059b382bfb1ff5588a518fc69c55b2ff6"
    "7d3facc11088e984d7c09c336d4875330121023bcbafb4f68455e0d1d117c178b0e82a"
    "84e66414f0987453d78da034b299c3a9ffffffffc3d450f208681405a0c7f0b46816f2"
    "121ef302e20c6b3c443b4f53228baa8f49000000006b48304502210081019ea7b68130"
    "da4230fd748668c776043004843de50e07bb5fcb42e7632aed022000a34878274e583e"
    "ec64815d1b587e7fbcd9ac714e722773ac1e69f1209f2e10012102b4b749d54e96b040"
    "66b0803e372a43d6ffa16e75a001ae0ed4b235674ab286beffffffff755d83f964d24f"
    "33de8f193a10932400bafcb47b9919351af0bf81e3e5d68007010000006b4830450221"
    "00add68e9532a50ca5585999290531f26e515bdf3d001519b0de8dd6b981daec7f0220"
    "0b34c58ce61e6673c9efc5bf82cacd4d02673bc1c6cbaba45b5c65579776b818012102"
    "5a2e04dc6bd5f58fe4eb13045b27f0dd17c39524264639f48607347cf6d69c4effffff"
    "ff0880778e06000000001976a914767c956efe6092a775fea39a06d1cac9aae956d788"
    "ac74ee5b05000000001976a914cab20e3270988ac99651b8f079a3b4c93b996a6888ac"
    "889c5d05000000001976a914b91f75254b5fa1510cc944a2206ed72235d0d88188ac80"
    "778e06000000001976a914a916707952c2df28a3abf3ee692dfbbd5a4d74dc88ac889c"
    "5d05000000001976a914e245b480b46bcbc9d13e68766ad19909decd135288ac80778e"
    "06000000001976a91416af241bb1db02dfd7c65989bbab190ac489ccc188ac889c5d05"
    "000000001976a9142994295a9d4d083eb792e669e3211007dc78928888ac80778e0600"
    "0000001976a9145ece2dac945c8ff5b2b6635360ca0478ade305d488ac00000000")
...
t_dummy_ext = {
    ...
    "external": {
        "79f1b8df7d0978f30028487c6c4e0eae96d1aa18e01f13bb4cba6788590cd431:1": {
            ...
            "P": "03"
                 "3749d513d0e0239a75892556a6ce01c3"
                 "e48f82e75169129abe8ef370ab992c94"
        }}}
